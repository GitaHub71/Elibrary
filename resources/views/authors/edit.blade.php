...
<form class="mt-4 mb-5" action="/authors/{{ $author->slug }}" method="post" enctype="multipart/form-data">
    @method('put')
    @csrf
    <div class="d-flex">
        <div class="col-md-6">
            <div class="mb-3">
                ...
                <input type="text" class="form-control form-control-sm @error('name') is-invalid @enderror" id="name" name="name" value="{{ old('name', $author->name) }}">
                @error('name')
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control form-control-sm @error('slug') is-invalid @enderror" id="slug" name="slug" value="{{ old('slug', $author->slug) }}">
                @error('slug')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
            ...
            <div class="mb-3">
                ...
                <input type="date" class="form-control form-control-sm @error('date_born') is-invalid @enderror" id="date_born" name="date_born" value="{{ old('date_born', $author->date_born) }}">
                @error('date_born')
            ...
            <div class="mb-3">
                ...
                <input id="bio" type="hidden" name="bio" value="{{ old('bio', $author->bio) }}">
        ...
        <div class="ms-5 col-md-5">
            <div class="d-flex justify-content-between mb-3">
                ...
                <input type="hidden" name="oldImage" value="{{ $author->photo }}">
                <div class="d-flex justify-content-center" style="height: 175px; width: 125px; border: 1px solid rgba(0,0,0,.125); border-radius: 0.25rem;">
                    @if ($author->photo)
                        <img src="{{ asset('storage/' . $author->photo) }}" class="img-preview img-fluid d-block">
                    @else
